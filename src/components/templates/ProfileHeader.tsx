...
export default function ProfileHeader({
  ...
  return (
    <div id="layout" className="flex mb-2">
      ...
      <div
        id="layout"
        className="flex relative h-26 w-26 justify-center items-center flex-shrink-0 bg-gray-800 rounded-full"
      >
      ...
      <div className="flex w-full justify-between items-center">
        ...
        <div id="layout" className="flex flex-col items-end">
          <span className="flex items-center">
            <h2 className="text-xl font-semibold">{profile.website}</h2>
          ...
          <span className="flex items-center">
            <h3 className="font-medium">{profile.phone}</h3>
